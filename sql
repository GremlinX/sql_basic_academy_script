...
## SELECT EM TODAS AS COLUNAS DA TABELA DEPARTAMENTO
SELECT * FROM UNIVERSIDADE.DEPARTAMENTO;

## SELECT NA COLUNA nome DA TABELA ALUNO
SELECT nome FROM UNIVERSIDADE.ALUNO;

## SELECT NA COLUNA codigo E horas DA TABELA ALUNO ONDE horas É MAIOR QUE 2
SELECT codigo, horas FROM UNIVERSIDADE.disciplina WHERE horas > 2;
